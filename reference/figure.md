...
Read by classifying pixels as ink / garment / skin / ground and measuring the
runs across named rows. Each fault is given with the measurement that catches
it, because none of them is visible at 1:1.
...
> *"[The femur] is joined to the bones of the pelvis at the hip socket by a long
> neck, which carries the shaft itself out beyond the widest part of the crest.
> From there the femora converge as they approach the knees, bringing the knee
...
- A **fold** is a line *of* the cloth. It must answer to a tension point, it
  ...
  weight from one silhouette to the other is a wire.
- A **seam, band, zip or printed stripe** is a line *on* the cloth, which makes it
